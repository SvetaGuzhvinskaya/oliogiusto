...
$document.on('click', function(e) {
	if (!$(e.target).closest($btnSearch.parent()).length) {
		$btnSearch.parent().removeClass('is-open');
	}
	e.stopPropagation();
});

// btn cart
var $btnCart = $('.js-cart-btn');
var $boxCart = $('.js-cart-box');
$btnCart.click(function() {
	$boxCart.css('top', $window.scrollTop());
	$boxCart.addClass('is-open');
});
$document.on('click', function(e) {
	if (!$(e.target).closest($btnCart).length && !$(e.target).closest($boxCart).length) {
...
// btn menu catalog
var $menuCat = $('.js-btn-menu-cat');
$menuCat.click(function() {
	$menuCat.parent('.has-child').removeClass('is-open');
...
// slider
var $jsSlickNews = $('.js-slider-news');
$jsSlickNews.slick({
	autoplay: false,
	autoplaySpeed: 3000,
	fade: true,
...
var $jsSlickProd = $('.js-prod-slider');
$jsSlickProd.slick({
	slidesToShow: 2,
	autoplay: true,
	autoplaySpeed: 3000,
